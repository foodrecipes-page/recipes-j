...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'j'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-j@main/recipes/<cuisine>/<diet>/<slug>.json
```
